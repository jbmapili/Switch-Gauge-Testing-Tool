...
namespace ButtonUserControl
{
    ...
    public partial class UserControl1: UserControl
    {
        ...
        public Color ButtonTextboxColor
        {
            get
            {
        ...
        public Color SwAddrTextboxColor
        {
            get
            {
                return this.BackColor;
            ...
            set
            {
                this.SwAddrTxt.BackColor = value;
            }
        }
        [Browsable(true)]
        ...
        public Color DoAddrTextboxColor
        {
            get
            {
                return this.BackColor;
            ...
            set
            {
                this.DoAddrTxt.BackColor = value;
            }
        }
        [Browsable(true)]
        ...
        public Color AnsAddrTextboxColor
        {
            get
            {
                return this.BackColor;
            ...
            set
            {
                this.AnsAddrTxt.BackColor = value;
            }
        }
        [Browsable(true)]

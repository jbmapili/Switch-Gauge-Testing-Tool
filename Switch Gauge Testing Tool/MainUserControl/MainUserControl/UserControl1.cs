...
namespace MainUserControl
{
    ...
    public partial class UserControl1: UserControl
    {
        ...
        public Color Intru1TextboxColor
        {
            get
            {
                return this.BackColor;
            ...
            set
            {
                this.Instru1Txt.BackColor = value;
            }
        }
        [Browsable(true)]
        ...
        public Color Intru2TextboxColor
        {
            get
            {
                return this.BackColor;
            ...
            set
            {
                this.Instru2Txt.BackColor = value;
            }
        }
        [Browsable(true)]
        ...
        public Color AmAddrTextboxColor
        {
            get
            {
                return this.BackColor;
            ...
            set
            {
                this.AmAddrTxt.BackColor = value;
            }
        }
        [Browsable(true)]
        ...
        public Color OpAddrTextboxColor
        {
            get
            {
                return this.BackColor;
            ...
            set
            {
                this.OpAddrTxt.BackColor = value;
            }
        }
        [Browsable(true)]
        ...
        public Color OPStatTextboxColor
        {
            get
            {
                return this.BackColor;
            ...
            set
            {
                this.OPStatText.BackColor = value;
            }
        }
        ...
        public void OpcOnOff(string addr, int value, Button btn)
        {
            ...
            {               
                ...
                if(addr.Contains("/"))
                {
                    ...
                    if (nErrorArray[0] != 0)
                    {
                        Debug.WriteLine("Error writing " + newaddr + " to OPC Server");
                        return;
                    }
                ...
                else
                {
                    ...
                    if (nErrorArray[0] != 0)
                    {
                        Debug.WriteLine("Error writing " + addr + " to OPC Server");
                        return;
                    }
                    if (opc.Read(target, out val, out wQualityArray, out fTimeArray, out nErrorArray) == true)
                    {
